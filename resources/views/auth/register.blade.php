            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm my-3 overflow-hidden">
                    <div class="row no-gutters">
                        ...
                        <div class="col-12 col-lg-7 bg-dark background-auth d-none d-lg-flex flex-fill bg-left-bottom bg-cover" style="background-image: url({{ asset('images/register.jpg') }})">
