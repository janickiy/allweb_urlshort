            ...
            <div class="row g-3">
                ...
                <div class="{{ isset($admin) ? 'col-12 col-lg-6' : 'col-12' }}">
                    <div class="mb-3">
                        ...
                        <label class="{{ isset($admin) ? 'form-label' : '' }}" for="workspace_color_dropdown">{{ __('ui.workspaces.color') }}</label>
                        ...
                        <div class="dropdown workspace-color-dropdown">
                            <button
                                ...
                                @if(isset($admin)) data-bs-toggle="dropdown" @else data-toggle="dropdown" @endif
                                aria-haspopup="true"
                                aria-expanded="false"
                            >
                                <span class="d-inline-flex align-items-center">
                                    <span id="workspace_color_preview" class="icon-label bg-{{ $selectedColorClass }} rounded-circle me-2 mr-2"></span>
                            ...
                            <ul class="dropdown-menu w-100" aria-labelledby="workspace_color_dropdown">
                                @foreach($workspaceColors as $key => $value)
                                    <li>
                                        ...
                                        >
                                            <span class="icon-label bg-{{ $value }} rounded-circle me-2 mr-2"></span>
            ...
            <script>
                document.addEventListener('DOMContentLoaded', () => {
                    ...
                    const updateColorPreview = (option) => {
                        ...
                        colorPreview.className = `icon-label bg-${colorClass} rounded-circle me-2 mr-2`;
