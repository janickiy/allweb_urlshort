@section('site_title', formatTitle([__('Workspaces'), config('settings.title')]))
...
<div class="d-flex">
    <div class="flex-grow-1">
        <h2 class="mb-3 d-inline-block">{{ __('Workspaces') }}</h2>
    </div>
    <div>
        <a href="{{ route('workspaces.new') }}" class="btn btn-primary mb-3">{{ __('New') }}</a>
    </div>
</div>
...
<div class="card border-0 shadow-sm">
    <div class="card-header align-items-center">
        <div class="row">
            <div class="col"><div class="font-weight-medium py-1">{{ __('Workspaces') }}</div></div>
            <div class="col-auto">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            @if(request()->input('sort'))
                                                <a href="{{ route('workspaces') }}" class="text-secondary">{{ __('Reset') }}</a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                ...
                @foreach($workspaces as $workspace)
                    <div class="list-group-item px-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                <a href="{{ route('workspaces.edit', $workspace->id) }}" class="btn btn-outline-primary btn-sm">{{ __('Edit') }}</a>
                            </div>
                        </div>
                    </div>
                @endforeach
