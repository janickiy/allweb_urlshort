                        ...
                        <div>
                            ...
                            <div class="text-muted mt-2">
                                <div class="d-inline-block {{ (__('lang_dir') == 'rtl' ? 'ml-4' : 'mr-4') }}">
                                    <div class="d-flex">
                                        <div class="d-inline-flex align-items-center">
                                            @include('icons.info', ['class' => 'fill-current icon-dashboard'])
                                        </div>
                                ...
                                <div class="d-inline-block {{ (__('lang_dir') == 'rtl' ? 'ml-4' : 'mr-4') }}">
                                    <div class="d-flex">
                                        <div class="d-inline-flex align-items-center">
                                            @include('icons.book', ['class' => 'fill-current icon-dashboard'])
                                        </div>
                                ...
                                <div class="d-inline-block {{ (__('lang_dir') == 'rtl' ? 'ml-4' : 'mr-4') }}">
                                    <div class="d-flex">
                                        <div class="d-inline-flex align-items-center">
                                            @include('icons.star', ['class' => 'fill-current icon-dashboard'])
                                        </div>
