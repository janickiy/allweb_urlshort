<?php $__env->startSection('site_title', formatTitle([__('Domains'), config('settings.title')])); ?>
...
<div class="d-flex">
    <div class="flex-grow-1">
        <h2 class="mb-3 d-inline-block"><?php echo e(__('Domains')); ?></h2>
    </div>
</div>
...
<div class="card border-0 shadow-sm">
    <div class="card-header align-items-center">
        <div class="row">
            <div class="col-12 col-md"><div class="font-weight-medium py-1"><?php echo e(__('Domains')); ?></div></div>
            <div class="col-12 col-md-auto">
                <form method="GET" action="<?php echo e(route('admin.domains')); ?>" class="d-md-flex">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <?php if(request()->input('sort')): ?>
                                                <a href="<?php echo e(route('admin.domains')); ?>" class="text-secondary"><?php echo e(__('Reset')); ?></a>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
        ...
        <?php else: ?>
            <div class="list-group list-group-flush my-n3">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-12 col-lg-5 d-flex">
                                        <div class="text-truncate">
                                            <div class="d-flex">
                                                <div class="text-truncate">
                                                    <a href="<?php echo e(route('admin.domains.edit', $domain->id)); ?>"><?php echo e(str_replace(['http://', 'https://'], '', $domain->name)); ?></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-lg-5 d-flex align-items-center">
                                        <div class="d-inline-block <?php echo e((__('lang_dir') == 'rtl' ? 'ml-3' : 'mr-3')); ?> list-avatar">
                                            <img src="<?php echo e(gravatar($domain->user->email, 48)); ?>" class="rounded-circle">
                                        </div>
                                        <a href="<?php echo e(route('admin.users.edit', $domain->user->id)); ?>"<?php if($domain->user->trashed()): ?> class="text-danger" <?php endif; ?>><?php echo e($domain->user->name); ?></a>
                                    </div>

                                    <div class="col-12 col-lg-2 d-flex">
                                        <a href="<?php echo e(route('admin.links', ['domain_id' => $domain->id])); ?>" class="text-dark"><?php echo e($domain->totalLinks); ?></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-auto">
                                <a href="<?php echo e(route('admin.domains.edit', $domain->id)); ?>" class="btn btn-outline-primary btn-sm"><?php echo e(__('Edit')); ?></a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="mt-3 align-items-center">
                    <div class="row">
                        <div class="col">
                            <div class="mt-2 mb-3"><?php echo e(__('Showing :from-:to of :total', ['from' => $domains->firstItem(), 'to' => $domains->lastItem(), 'total' => $domains->total()])); ?>

                            </div>
                        </div>
                        <div class="col-auto">
                            <?php echo e($domains->onEachSide(1)->links()); ?>
...
</div><?php /**PATH /var/www/site3.loc/www/resources/views/admin/domains/list.blade.php ENDPATH**/ ?>