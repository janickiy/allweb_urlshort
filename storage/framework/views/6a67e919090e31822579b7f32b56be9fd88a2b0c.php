<?php $__env->startSection('site_title', formatTitle([__('Pages'), config('settings.title')])); ?>
...
<div class="d-flex">
    <div class="flex-grow-1">
        <h2 class="mb-3 d-inline-block"><?php echo e(__('Pages')); ?></h2>
    </div>
    <div>
        <a href="<?php echo e(route('admin.pages.new')); ?>" class="btn btn-primary mb-3"><?php echo e(__('New')); ?></a>
    </div>
</div>
...
<div class="card border-0 shadow-sm">
    <div class="card-header align-items-center">
        <div class="row">
            <div class="col"><div class="font-weight-medium py-1"><?php echo e(__('Pages')); ?></div></div>
            <div class="col-auto">
                <form method="GET" action="<?php echo e(route('admin.pages')); ?>">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <?php if(request()->input('sort')): ?>
                                                <a href="<?php echo e(route('admin.pages')); ?>" class="text-secondary"><?php echo e(__('Reset')); ?></a>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
        ...
        <?php else: ?>
            <div class="list-group list-group-flush my-n3">
                ...
                <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="list-group-item px-0">
                        <div class="row align-items-center">
                            <div class="col">
                                <div>
                                    <a href="<?php echo e(route('admin.pages.edit', $page->id)); ?>"><?php echo e($page->title); ?></a>
                                </div>
                            </div>
                            <div class="col-auto">
                                <a href="<?php echo e(route('admin.pages.edit', $page->id)); ?>" class="btn btn-outline-primary btn-sm"><?php echo e(__('Edit')); ?></a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="mt-3 align-items-center">
                    <div class="row">
                        <div class="col">
                            <div class="mt-2 mb-3"><?php echo e(__('Showing :from-:to of :total', ['from' => $pages->firstItem(), 'to' => $pages->lastItem(), 'total' => $pages->total()])); ?>

                            </div>
                        </div>
                        <div class="col-auto">
                            <?php echo e($pages->onEachSide(1)->links()); ?>
...
</div><?php /**PATH /var/www/site3.loc/www/resources/views/admin/pages/list.blade.php ENDPATH**/ ?>